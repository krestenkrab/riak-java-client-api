...
/**
 * A {@link RiakObject} implementation that covers the basics. Minimally
 * mutable, only value, contentType, links and userMeta can be mutated.
 * 
...
public class DefaultRiakObject implements RiakObject {
     ...
     * @param userMeta
     */
    DefaultRiakObject(Bucket bucket, String key, VClock vclock, boolean conflict, String vtag, final Date lastModified,
            String contentType, String value, final Collection<RiakObject> siblings, final Collection<RiakLink> links,
        ...
        this.value = value;
        this.siblings = Collections.unmodifiableCollection(deepCopy(siblings));
     ...
     */
    public void removeUsermeta(String key) {
        synchronized (userMetaLock) {
            userMeta.remove(key);
        }
    }
    ...
    /**
     * 
     * @return a *copy* of the user meta for this object.
     */
